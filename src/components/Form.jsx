...
function Form() {
  ...
  const calculate = async () => {
    try {
      ...
      const url = `https://libertyrunners-app.com/calculate-pace?distance=${distance}&hour=${hour}&minute=${minute}&second=${second}&paceMinute=${paceMinute}&paceSecond=${paceSecond}`;
